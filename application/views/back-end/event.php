<form action="<?php echo base_url('Admin/saveEvent') ?>" method="POST" enctype="multipart/form-data">
            ...
            if($img) {
                ...
                <div class="col-sm-3">
                    <div class="card" style="width: 18rem;">
                        <img src="<?php  echo base_url('assets/img/events/').$value->url_img?>" alt="" style="width:18rem;height:10rem">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $value->title; ?></h5>
                            <p class="card-text"><?php echo $value->description; ?></p>
                            <a href="<?php echo base_url('Admin/deleteEvent/'.$value->id) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                    </div>
                </div>
                <?php  }   
